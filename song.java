...
public class Song {
 ...
 System.out.println("\"Parse error,\" cried the compiler");
   ...
   public static void sixthVerse() {
      System.out.println("The program was missing a curly bracket on the first line");
      System.out.println("Hopping that it would be the last error and would work fine");
      same4();
   }
...
Scum,");
   ...
   public static void same4() {
      System.out.println("I added a curly bracket next to the name of program");
      same1();
   }
